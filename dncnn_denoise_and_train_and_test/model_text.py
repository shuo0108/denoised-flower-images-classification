...
def model_text(tfrecord_path):
    ...
    image_made(tfrecord_path,img_dir)
    ...
    print('num of text image:'+str(len(denoise_img_path)))
    
    # Unpersists graph from file
    with tf.gfile.FastGFile("/home/hs/flowers_classification_1/1-8000.pb", 'rb') as f:
        graph_def = tf.GraphDef()
        graph_def.ParseFromString(f.read())
    ...
    with tf.Session() as sess:
        ...
        for im_p in denoise_img_path:
            im_path=os.path.join(denoise_imgdir_path,im_p)
...
def main():
    ...
    tfrecord_path='/home/hs/flowers_classification_1/挑战第二关dataX/TFcodeX_10.tfrecord'
