...
class train_data():
    ...
    def __init__(self,filepath='/home/cpssface/hs/flowers_classification_1/denoise/data/img_clean_and_noise_pats.npy'):
...
def load_data(filepath='/home/hs/flowers_classification_1/denoise/data/img_clean_and_noise_pats.npy'):
